...
Once the Kubernetes cluster is available, you can proceed to install the Helm client [client]({%link https://docs.helm.sh/using_helm/#installing-helm %}) in your machine.
