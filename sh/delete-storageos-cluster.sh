...
#############################################################################
# Script Name	 :   delete-storageos-cluster.sh                                                                                           
# Description	 :   Uninstall StorageOS Self-Evaluation Cluster                                                                              
# Args         :                                                                                           
# Author       :   StorageOS
...
# StorageOS Self-Evaluation This script will remove StorageOS from a
# Kubernetes cluster
# 
# This script removes a self-evaluation cluster based on the installation 
# instructions in our self-evaluation guide: https://docs.storageos.com/docs/self-eval. 
# 
# This script will removes all components and persistent volumes from the 
# Kubernetes cluster. Please see the "Uninstall StorageOS" documentation for
# more information: https://docs.storageos.com/v2.4-rc/docs/operations/uninstall/ 
# 
# Expectations:
